...
def main():
    ...
    if args.notice == "email":
        ...
        # robot_url = getpass(f"Enter the URL for Feishu robot: ")  # ye
        robot_url = 'https://open.feishu.cn/open-apis/bot/v2/hook/25f8ec8a-5b96-4ce9-8297-8b02da399561'
    
    while True:
        print("ye_start enter")
        logs = read_logs(
            config["remote_host"],
            config["remote_user"],
