# Copied from https://github.com/huggingface/lerobot/blob/f0d2b37b/src/lerobot/policies/pi_gemma.py
...
def _get_pi_gemma_decoder_layer_base():
    ...
    class _PiGemmaDecoderLayerBase(GradientCheckpointingLayer):
        """Decoder layer that uses PiGemmaRMSNorm and _gated_residual, compatible with stock Gemma."""
...
class PiGemmaModel(GemmaModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # lerobot uses `inputs_embeds` here, but transformers>=4.57 renamed the param to `input_embeds`.
